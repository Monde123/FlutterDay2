...
class _LineChartSample2State extends State<LineChartSample2> {
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    const style = TextStyle(fontWeight: FontWeight.w500, fontSize: 12);
    Widget text;
    switch (value.toInt()) {
      case 2:
  ...
  Widget rightTitleWidgets(double value, TitleMeta meta) {
    const style = TextStyle(fontWeight: FontWeight.w600, fontSize: 10);
    String text;
    switch (value.toInt()) {
      case 1:
        text = '10K';
    ...
    return LineChartData(
      gridData: FlGridData(
        ...
        getDrawingVerticalLine: (value) {
          return const FlLine(
            color: Color.fromARGB(31, 245, 243, 243),
            strokeWidth: 1,
          );
        },
      ),
